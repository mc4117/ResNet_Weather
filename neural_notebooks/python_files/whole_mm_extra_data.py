...
for i in range(4):
    ...
    filename = '/rds/general/user/mc4117/ephemeral/saved_models/whole_mm_extra_data_' + str(i)
    ...
    for j in range(number_of_forecasts):
        ...
        filename_2 = '/rds/general/user/mc4117/ephemeral/saved_pred/whole_mm_extra_data_' + str(i)
