...
cnn.save_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/whole_bn_no_do_72.h5')
...
cnn_2.layers[0].set_weights(cnn.layers[0].get_weights())
cnn_2.layers[1].set_weights(cnn.layers[1].get_weights())
cnn_2.layers[2].set_weights(cnn.layers[2].get_weights())
cnn_2.layers[3].set_weights(cnn.layers[3].get_weights())
cnn_2.layers[4].set_weights(cnn.layers[4].get_weights())
cnn_2.layers[5].set_weights(cnn.layers[5].get_weights())
cnn_2.layers[6].set_weights(cnn.layers[6].get_weights())
cnn_2.layers[7].set_weights(cnn.layers[7].get_weights())
cnn_2.layers[8].set_weights(cnn.layers[8].get_weights())
cnn_2.layers[10].set_weights(cnn.layers[9].get_weights())
...
fc = create_predictions(cnn_2, dg_test)
...
for i in range(number_of_forecasts):
    ...
    np.save('/rds/general/user/mc4117/home/WeatherBench/saved_pred/whole_bn_no_do_72.npy', pred_ensemble)
