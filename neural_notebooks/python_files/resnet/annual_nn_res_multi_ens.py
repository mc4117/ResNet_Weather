...
for mc in range(5):
    ...
    cnn.fit(x = dg_train, epochs=100, validation_data=dg_valid, callbacks=[early_stopping_callback, reduce_lr_callback])

    cnn.save_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_gpu_annual_res_' +str(mc) + '_' + str(var_name) + '.h5')
