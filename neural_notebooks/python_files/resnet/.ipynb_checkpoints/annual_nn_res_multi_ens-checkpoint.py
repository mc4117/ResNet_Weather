...
for i in range(5):
    if var_name == 'specific_humidity':
        cnn = build_resnet_cnn([64, 64, 64, 64, 2], [5, 5, 5, 5, 5], (32, 64, 4))
    elif var_name == 'pot_vort':
        cnn = build_resnet_cnn([64, 64, 64, 64, 2], [5, 5, 5, 5, 5], (32, 64, 4))
    elif var_name == 'const':
        cnn = build_resnet_cnn([64, 64, 64, 64, 2], [5, 5, 5, 5, 5], (32, 64, 5))
    elif var_name == 'orig':
        cnn = build_resnet_cnn([64, 64, 64, 64, 2], [5, 5, 5, 5, 5], (32, 64, 2))
    elif var_name == 'multi':
        cnn = build_resnet_cnn([64, 64, 64, 64, 2], [5, 5, 5, 5, 5], (32, 64, 10))
    else:
        cnn = build_resnet_cnn([64, 64, 64, 64, 2], [5, 5, 5, 5, 5], (32, 64, 3))
    
    if var_name != 'orig':
        cnn_orig = build_resnet_cnn([64, 64, 64, 64, 2], [5, 5, 5, 5, 5], (32, 64, 2))
        cnn_orig.load_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_gpu_annual_res_orig.h5')
        j = 2
        i = 2
    ...
    cnn.fit(x = dg_train, epochs=100, validation_data=dg_valid, callbacks=[early_stopping_callback, reduce_lr_callback, model_checkpoint_callback])

    cnn.save_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_gpu_annual_res_' +str(i) + '_' + str(var_name) + '.h5')
