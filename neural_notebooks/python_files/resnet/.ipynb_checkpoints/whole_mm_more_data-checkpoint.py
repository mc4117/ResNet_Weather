...
for i in range(4):
    cnn = build_resnet_cnn([64, 64, 64, 64, 2], [5, 5, 5, 5, 5], (32, 64, 10), l2 = 1e-5)
    ...
    filename = '/rds/general/user/mc4117/ephemeral/saved_models/whole_res_more_data_' + str(i)
    ...
    for j in range(number_of_forecasts):
        ...
        filename_2 = '/rds/general/user/mc4117/ephemeral/saved_pred/whole_res_more_data_' + str(i)
