...
if var_name == 'specific_humidity':
    cnn = build_resnet_cnn([64, 64, 64, 2], [5, 5, 5, 5], (32, 64, 4))
elif var_name == 'pot_vort':
    cnn = build_resnet_cnn([64, 64, 64, 2], [5, 5, 5, 5], (32, 64, 4))
elif var_name == 'const':
    cnn = build_resnet_cnn([64, 64, 64, 2], [5, 5, 5, 5], (32, 64, 5))
elif var_name == 'orig':
    cnn = build_resnet_cnn([64, 64, 64, 2], [5, 5, 5, 5], (32, 64, 2))
else:
    cnn = build_resnet_cnn([64, 64, 64, 2], [5, 5, 5, 5], (32, 64, 3))
...
cnn.fit(x = dg_train, epochs=30, validation_data=dg_valid, callbacks=[tf.keras.callbacks.EarlyStopping(
                        monitor='val_loss',
                        min_delta=0,
                        patience=2,
                        verbose=1, 
...
cnn.save_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_resnet_annual' + str(var_name) + '.h5')
