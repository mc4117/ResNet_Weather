...
bin_values = np.linspace(0, 99, 100)

output_avg_geo = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_geo_[300, 400, 500, 600, 700, 850]_preds_cat_val.npy'), bin_values), axis = -1)
output_avg_temp = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_temp_[300, 400, 500, 600, 700, 850]_preds_cat_val.npy'), bin_values), axis = -1)
output_avg_pv = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_pot_vort_[150, 250, 300, 700, 850]_preds_cat_val.npy'), bin_values), axis = -1)
output_avg_sh = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_specific_humidity_[150, 200, 600, 700, 850, 925, 1000]_preds_cat_val.npy'), bin_values), axis = -1)
...
output_avg_const = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_const_no_l_preds_cat_val.npy'), bin_values), axis = -1)
...
def my_init(shape, dtype=None):
    print(shape)
    return tf.ones(shape, dtype=dtype)/25
...
ensemble_model.load_weights('stacked_cat_9_avg.h5')
...
output_test_temp = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_temp_[300, 400, 500, 600, 700, 850]_preds_cat_test.npy'), bin_values), axis = -1)
output_test_pv = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_pot_vort_[150, 250, 300, 700, 850]_preds_cat_test.npy'), bin_values), axis = -1)
output_test_sh = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_specific_humidity_[150, 200, 600, 700, 850, 925, 1000]_preds_cat_test.npy'), bin_values), axis = -1)
#output_avg_sr = np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_solar_rad_no_l_preds_cat_val.npy'), bin_values)
output_test_const = np.expand_dims(np.dot(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/' + str(block_no) + '_const_no_l_preds_cat_test.npy'), bin_values), axis = -1)
