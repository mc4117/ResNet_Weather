...
np.save('/rds/general/user/mc4117/ephemeral/saved_pred/pretrain_categorical' + str(lr) + '.npy', fc_arg)
...
rmse = compute_weighted_rmse(fc_arg, ds_test.z.sel(level=500)[72:]).compute()
print(rmse)
