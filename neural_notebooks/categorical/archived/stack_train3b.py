...
ensemble_model.fit(x = stack_test_list, y = y1, epochs = 2400, validation_split = 0.1, shuffle = True, verbose =2,
                  callbacks = [early_stopping_callback, reduce_lr_callback
                    ])

ensemble_model.save_weights('stacked_cat_9_trainb.h5')
