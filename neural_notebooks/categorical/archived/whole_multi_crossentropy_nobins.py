...
cnn = build_cnn([64, 64, 64, 64, 1], [5, 5, 5, 5, 5], (32, 64, 2))
...
cnn.save_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/whole_cat_multi_crossent_t_no_bins_nores.h5')
