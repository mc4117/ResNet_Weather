...
output_avg_wind =  np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/25_wind_[50, 100, 300, 850, 925, 1000]_preds_cat_t_val.npy'), axis = -1)
output_avg_geo = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/27_geo_[500, 600, 700, 850, 925, 1000]_preds_cat_t_val.npy'), axis = -1)
output_avg_temp = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/23_temp_[500, 600, 700, 850, 925, 1000]_preds_cat_t_val.npy'),axis = -1)
output_avg_pv = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/25_pot_vort_[150, 250, 300, 700, 850]_preds_cat_t_val.npy'), axis = -1)
output_avg_sh = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/25_specific_humidity_[150, 200, 600, 700, 850, 925, 1000]_preds_cat_t_val.npy'), axis = -1)
output_avg_const = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/23_const_no_l_preds_cat_t_val.npy'), axis = -1)
...
ensemble_model.save_weights('stacked_cat_opt_train_t.h5')

output_test_wind = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/25_wind_[50, 100, 300, 850, 925, 1000]_preds_cat_t_test.npy'), axis = -1)
output_test_geo = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/27_geo_[500, 600, 700, 850, 925, 1000]_preds_cat_t_test.npy'), axis = -1)
output_test_temp = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/23_temp_[500, 600, 700, 850, 925, 1000]_preds_cat_t_test.npy'), axis = -1)
output_test_pv = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/25_pot_vort_[150, 250, 300, 700, 850]_preds_cat_t_test.npy'), axis = -1)
output_test_sh = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/25_specific_humidity_[150, 200, 600, 700, 850, 925, 1000]_preds_cat_t_test.npy'), axis = -1)
output_test_const = np.expand_dims(np.load('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/23_const_no_l_preds_cat_t_test.npy'), axis = -1)
