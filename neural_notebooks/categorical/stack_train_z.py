...
stack_test_list = [output_avg_geo_mean, output_avg_temp_mean, output_avg_pv_mean, output_avg_sh_mean, output_avg_const_mean, output_avg_sr_mean]
...
stack_test_test = [output_test_geo_mean, output_test_temp_mean, output_test_pv_mean, output_test_sh_mean, output_test_const_mean, output_test_sr_mean]
