# postprocessing of outputs to include in a stacked ensemble. Training of stacked model and calculation of error from stacked model
...
temp_levels_31 = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/31_temp_[300, 400, 500, 600, 700, 850]_preds_newval.nc')
...
print('31')
print(compute_weighted_rmse(temp_levels_31, real_ds))
print('29')
