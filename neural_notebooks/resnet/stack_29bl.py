...
temp_levels = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_temp_[300, 400, 500, 600, 700, 850]_preds_newval.nc')
geo_levels = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_geo_[300, 400, 500, 600, 700, 850]_preds_newval.nc')

sh = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_specific_humidity_[300, 500, 600, 700, 850, 925, 1000]_preds_newval.nc')
pv = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_pot_vort_[150, 250, 300, 700, 850]_preds_newval.nc')
const = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_const_None_preds_newval.nc')
...
geo_levels_rearranged = xr.Dataset({
    'z': xr.DataArray(
        geo_levels.z.values,
        dims=['time', 'lat', 'lon'],
        coords={'time':dg_valid.data.time[72:], 'lat': dg_valid.data.lat, 'lon': dg_valid.data.lon,
...
print(compute_weighted_rmse(geo_levels_rearranged, real_ds))
print(compute_weighted_rmse(sh, real_ds))
print(compute_weighted_rmse(pv_rearranged, real_ds))
print(compute_weighted_rmse(const_rearranged, real_ds))

mean_z_t = dg_test.mean.isel(level=dg_test.output_idxs).values
std_z_t = dg_test.std.isel(level=dg_test.output_idxs).values

temp_norm = (np.transpose(temp_levels.to_array().data, axes = [1, 2, 3, 0]) - mean_z_t)/std_z_t
geo_norm = (np.transpose(geo_levels_rearranged.to_array().data, axes = [1, 2, 3, 0]) - mean_z_t)/std_z_t
...
const_norm = (np.transpose(const_rearranged.to_array().data, axes = [1, 2, 3, 0])-mean_z_t)/std_z_t
...
ensemble_model.save_weights('stacked_val_comb_29.h5')
...
temp_levels_test = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_temp_[300, 400, 500, 600, 700, 850]_preds_newtest.nc')
geo_levels_test = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_geo_[300, 400, 500, 600, 700, 850]_preds_newtest.nc')

sh_test = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_specific_humidity_[300, 500, 600, 700, 850, 925, 1000]_preds_newtest.nc')
pv_test = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_pot_vort_[150, 250, 300, 700, 850]_preds_newtest.nc')
const_test = xr.open_dataset('/rds/general/user/mc4117/home/WeatherBench/saved_pred_data/29_const_None_preds_newtest.nc')
...
const_rearranged_test = xr.Dataset({
    'z': xr.DataArray(
        const_test.z.values,
        dims=['time', 'lat', 'lon'],
        coords={'time':dg_test.data.time[72:], 'lat': dg_test.data.lat, 'lon': dg_test.data.lon,
...
temp_test_norm = (np.transpose(temp_levels_test.to_array().data, axes = [1, 2, 3, 0]) - mean_z_t)/std_z_t
...
const_test_norm = (np.transpose(const_rearranged_test.to_array().data, axes = [1, 2, 3, 0])-mean_z_t)/std_z_t
