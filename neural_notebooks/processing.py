...
def build_cnn(filters, kernels, input_shape, dr=0):
    ...
    x = GaussianNoise(20*abs(dg_train.data.mean(('time','lat', 'lon'))))(x)    
...
cnn.load_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/whole_train_72_noise.h5')
