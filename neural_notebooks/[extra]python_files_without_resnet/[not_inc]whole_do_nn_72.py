# In this file we experiment with using dropout to create an ensemble
...
cnn.save_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/whole_do_72.h5')
...
for i in range(number_of_forecasts):
    ...
    np.save('/rds/general/user/mc4117/home/WeatherBench/saved_pred/whole_do_72.npy', pred_ensemble)
