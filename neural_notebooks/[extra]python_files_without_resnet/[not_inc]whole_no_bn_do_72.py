# In this file we experiment with using dropout in a simple neural network to create an ensemble but without using batch normalisation
...
cnn.save_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/whole_no_bn_do_72.h5')
...
for i in range(number_of_forecasts):
    ...
    np.save('/rds/general/user/mc4117/home/WeatherBench/saved_pred/whole_no_bn_do_72.npy', pred_ensemble)
