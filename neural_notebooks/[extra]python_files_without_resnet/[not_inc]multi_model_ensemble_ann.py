# In this file we experiment with using a multimodel dropout approach on a simple neural network.

# For speed instead of using the full dataset we only use yearly data  
