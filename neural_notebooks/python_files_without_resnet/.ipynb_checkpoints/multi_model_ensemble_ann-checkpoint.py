...
for i in range(4):
    ...
    filename = '/rds/general/user/mc4117/home/WeatherBench/saved_models/train_72_multi_data_gpu_' + str(i)
...
pred_ensemble_1 = np.load('/rds/general/user/mc4117/home/WeatherBench/saved_models/train_72_multi_data_gpu_1.npy')
pred_ensemble_2 = np.load('/rds/general/user/mc4117/home/WeatherBench/saved_models/train_72_multi_data_gpu_2.npy')
pred_ensemble_3 = np.load('/rds/general/user/mc4117/home/WeatherBench/saved_models/train_72_multi_data_gpu_3.npy')
pred_ensemble_4 = np.load('/rds/general/user/mc4117/home/WeatherBench/saved_models/train_72_multi_data_gpu_4.npy')

pred_ensemble = np.concatenate((pred_ens_1, pred_ens_2_a), axis =4)

np.save('/rds/general/user/mc4117/home/WeatherBench/saved_models/train_72_multi_data_gpu_concat.npy', pred_ensemble)