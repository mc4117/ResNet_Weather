...
for i in range(4):
    ...
    filename = '/rds/general/user/mc4117/home/WeatherBench/saved_models/72_multi_data_gpu_more_pv' + str(i)
    ...
    for j in range(number_of_forecasts):
        ...
        np.save(filename + '.npy', pred_ensemble)
    
pred_ensemble_1 = np.load('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_multi_data_gpu_more_pv_1.npy')
pred_ensemble_2 = np.load('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_multi_data_gpu_more_pv_2.npy')
pred_ensemble_3 = np.load('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_multi_data_gpu_more_pv_3.npy')
pred_ensemble_4 = np.load('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_multi_data_gpu_more_pv_4.npy')

pred_ensemble = np.concatenate((pred_ens_1, pred_ens_2_a), axis =4)

np.save('/rds/general/user/mc4117/home/WeatherBench/saved_models/72_multi_data_gpu_more_pv_concat.npy', pred_ensemble)