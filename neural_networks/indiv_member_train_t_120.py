# USED FOR INPUTS FOR STACKING NETWORK TO PREDICT 5-day FORECAST FOR T850
# Splits data into four sets and makes predictions for dg_valid2 which 
# is then fed into stacked model and for dg_test which is the test dating 
# set at the end of the simulation.
...
# 5 day forecast so lead time of 72 hrs
bs=32
lead_time=120
output_vars = ['t_850']
...
# create predictions to be used as inputs for the stacked neural network
no_of_forecasts = 32
...
# create predictions to be used as test dataset for the stacked neural network
output_total = 0
