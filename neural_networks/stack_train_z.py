# File which trains stacking neural networks for z500 for 3-day forecast using inputs generated using indiv_member_train_z.py
...
ensemble_model.save_weights('stacked_cat_' + str(block_no) + '_train_7.h5')
