# Trains residual neural network with no dropout on categorical Z500 output data for 3-day forecast. The number of blocks is specified in the command line
...
# Create a training and validation data generator. Use the train mean, std and bins for validation and test as well.
...
cnn.save_weights('/rds/general/user/mc4117/home/WeatherBench/saved_models/whole_cat_crossent_non_ohe_' + str(block_no) + '.h5')
